...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Sistem Pelaporan ONLIMO | Dashboard</title>
        ...
        <link href="<?php echo base_url('assets/AdminLTE-2.0.5/dist/css/skins/skin-blue-light.min.css') ?>" rel="stylesheet" type="text/css" />
