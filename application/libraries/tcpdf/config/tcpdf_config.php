 ...
 */
define ('PDF_HEADER_LOGO', 'logo_onlimo.png');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'ONLIMO');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'ONLIMO');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'ONLIMO Air');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Online Monitoring\nwww.onlimo.bppt.go.id");
